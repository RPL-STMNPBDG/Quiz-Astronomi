...
public class hasilquiz2 extends AppCompatActivity {
    String name;
    ...
    protected void onCreate (Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_hasilquiz2);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(hasilquiz2.this,home.class);
                startActivity(i);
                finish();
            }
        });
        ...
        replay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(hasilquiz2.this,quiz2.class);
                startActivity(i);
                finish();
            }
        });
